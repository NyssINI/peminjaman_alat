            ...
            <nav class="flex-1 mt-6 px-4 space-y-2">
                @if (auth()->user()->role === 'admin')
                    <a href="{{ route('users.index') }}"
                        class="group flex items-center p-3 rounded-xl {{ request()->routeIs('users.index') ? 'bg-indigo-900 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }} transition-all duration-200">
                        <div
                    ...
                    <a href="{{ route('kategori.index') }}"
                        class="group flex items-center p-3 rounded-xl {{ request()->routeIs('kategori.*') ? 'bg-indigo-900 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }} transition-all duration-200">
                        <div
                            class="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-800 mr-2 group-hover:bg-indigo-500/20 group-hover:text-indigo-400 transition-all">
                    ...
                    <a href="{{ route('alat.index') }}"
                        class="group flex items-center p-3 rounded-xl {{ request()->routeIs('alat.*') ? 'bg-indigo-900 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }} transition-all duration-200">
                        <div
                            class="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-800 mr-2 group-hover:bg-indigo-500/20 group-hover:text-indigo-400 transition-all">
                    ...
                    <a href="{{ route('datapeminjaman.index') }}"
                        class="group flex items-center p-3 rounded-xl {{ request()->routeIs('datapeminjaman.*') ? 'bg-indigo-900 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }} transition-all duration-200">
                        <div
                            class="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-800 mr-2 group-hover:bg-indigo-500/20 group-hover:text-indigo-400 transition-all">
                     ...
                     <a href="{{ route('logaktivitas.index') }}"
                        class="group flex items-center p-3 rounded-xl {{ request()->routeIs('logaktivitas.*') ? 'bg-indigo-900 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }} transition-all duration-200">
                        <div
                            class="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-800 mr-2 group-hover:bg-indigo-500/20 group-hover:text-indigo-400 transition-all">
                ...
                @if (auth()->user()->role === 'petugas')
                    <a href="{{ route('petugas.index') }}"
                        class="group flex items-center p-3 rounded-xl {{ request()->routeIs('petugas.*') ? 'bg-indigo-900 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }} transition-all duration-200">
                        <div
                            class="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-800 mr-2 group-hover:bg-indigo-500/20 group-hover:text-indigo-400 transition-all">
            ...
            <div class="p-4 border-t border-slate-800">
                <div class="flex items-center mb-4 px-2">
                    ...
                    <div class="overflow-hidden">
                        ...
                        <p class="text-xs text-slate-500 italic capitalize">{{ auth()->user()->role }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 text-slate-600">
                    ...
                    <div class="flex flex-col items-end">
                        <span
                            ...
                            Ini</span>
                        <span class="text-sm font-bold text-slate-700 leading-none">{{ date('d M Y') }}</span>
                    </div>
                </div>
            </header>
