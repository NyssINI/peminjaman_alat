...
<?php $__env->startSection('content'); ?>
    <div class="flex justify-between items-center mb-6 text-slate-800">
        ...
        <a href="<?php echo e(route('alat.create')); ?>"
                ...
                <?php $__empty_1 = true; $__currentLoopData = $alat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600 font-semibold">
                            <?php echo e($item->stok); ?> <span class="text-[10px] text-slate-400">Unit</span>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <div class="flex justify-center gap-3">
                                <a href="<?php echo e(route('alat.edit', $item->id)); ?>"
                                ...
                                <form action="<?php echo e(route('alat.destroy', $item->id)); ?>" method="POST" class="inline">
                                    ...
                                    <button type="submit"
                                        ...
                                        onclick="return confirm('Hapus alat <?php echo e($item->nama_alat); ?>?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\peminjaman_alat\resources\views/alat/index.blade.php ENDPATH**/ ?>