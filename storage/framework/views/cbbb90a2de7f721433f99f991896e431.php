    ...
    <?php if(session('warning')): ?>
        <script>
            Swal.fire({
                ...
                html: '<span class="text-slate-500 font-medium"><?php echo e(session('warning')); ?></span>',
    ...
    <?php if(session('info')): ?>
        <script>
            Swal.fire({
                ...
                html: '<span class="text-slate-500 font-medium"><?php echo e(session('info')); ?></span>',
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?php echo e(route('peminjam.index')); ?>";
                }
            });
        </script>
    <?php endif; ?>
